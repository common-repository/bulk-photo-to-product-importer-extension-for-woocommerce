                        ...
                        <?php foreach( $group->variations as $item ) : ?>
                            <table class="row">
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" style="height: 16px; width: 16px;" name="variations[<?php echo $count; ?>][downloadable]" <?php echo $item['_downloadable'] == 'yes' ? 'checked="checked"' : '' ?> />
                                    </td>
                                </tr>
                            </table> 
